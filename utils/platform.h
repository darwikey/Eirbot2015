 ...
 * USART  *
 *********/
#define PLATFORM_USART_PRINTF USART3
...
// ENABLE
#define PLATFORM_ENABLE_AUSBEE_MOTOR1_PIN GPIO_Pin_0
#define PLATFORM_ENABLE_AUSBEE_MOTOR1_PORT GPIOE
#define PLATFORM_ENABLE_AUSBEE_MOTOR2_PIN GPIO_Pin_1
#define PLATFORM_ENABLE_AUSBEE_MOTOR2_PORT GPIOE

// DIR
#define PLATFORM_DIR_AUSBEE_MOTOR1_PIN GPIO_Pin_2
#define PLATFORM_DIR_AUSBEE_MOTOR1_PORT GPIOE
#define PLATFORM_DIR_AUSBEE_MOTOR2_PIN GPIO_Pin_3
#define PLATFORM_DIR_AUSBEE_MOTOR2_PORT GPIOE

// PWM
#define PLATFORM_PWM_AUSBEE_MOTOR1_PIN GPIO_Pin_5
#define PLATFORM_PWM_AUSBEE_MOTOR1_PORT GPIOE
#define PLATFORM_PWM_AUSBEE_MOTOR1_PIN_SOURCE GPIO_PinSource5
#define PLATFORM_PWM_AUSBEE_MOTOR1_GPIO_AF GPIO_AF_TIM9
#define PLATFORM_PWM_AUSBEE_MOTOR2_PIN GPIO_Pin_6
#define PLATFORM_PWM_AUSBEE_MOTOR2_PORT GPIOE
#define PLATFORM_PWM_AUSBEE_MOTOR2_PIN_SOURCE GPIO_PinSource6
#define PLATFORM_PWM_AUSBEE_MOTOR2_GPIO_AF GPIO_AF_TIM9
#define PLATFORM_TIMER_AUSBEE_MOTOR1 TIM9
#define PLATFORM_TIMER_AUSBEE_MOTOR2 TIM9


// Parametres pour driver lm18200
// DIR
...
#define PLATFORM_ENC1_TIMER            TIM1
...
#define PLATFORM_ENC2_TIMER            TIM3
